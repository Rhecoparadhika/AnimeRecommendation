...
def load_data(ratio, neighbor_sample_size):
    n_user, n_item, train_data, eval_data, test_data = load_rating(ratio)
    n_entity, n_relation, adj_entity, adj_relation = load_kg(neighbor_sample_size)
...
def load_kg(neighbor_sample_size):
    ...
    adj_entity, adj_relation = construct_adj(neighbor_sample_size, kg, n_entity)
...
def construct_kg(kg_np):
    ...
    file = open("Knowledge Graph.txt","w")
...
def construct_adj(neighbor_sample_size, kg, entity_num):
    ...
    for entity in range(entity_num):
        ...
        if n_neighbors >= neighbor_sample_size:
            ...
            sampled_indices = random.sample(list(range(n_neighbors)), neighbor_sample_size)
        else:
